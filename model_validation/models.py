...
#         all_outputs = super().forward(branch_input, trunk_input)
#         head_outputs = torch.split(all_outputs, 1, dim=1)
        
#         return {
#             name: output.squeeze(1) for name, output in zip(self.head_names, head_outputs)
#         }
